...
function userSignUp(user) {
    return __awaiter(this, void 0, void 0, function () {
        var userData, salt, hashedPassword, newUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, usersRepository_1.findUser)(user.email)];
                case 1:
                    userData = _a.sent();
                    if (userData) {
                ...
                case 3:
                    ...
                    newUser = ({ email: user.email, password: hashedPassword });
                    return [4 /*yield*/, (0, usersRepository_1.createUser)(newUser)];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
